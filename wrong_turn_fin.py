...
def detect_turn(video_path, output_video_path):
    ...
    #def detect_turn(video_path, output_video_path, model_path='best.pt', class_list_path='coco1.txt'):
    # Initialize the video capture, saving output to a video
    cap = cv2.VideoCapture('wrongturns.mp4')
    #creating folder to save output to folder
    output_video_path = 'wrongway.mp4'
    ...
    info_list = ["wrongturns.mp4", "illegal_turn", "Kingston", datetime.now().strftime("%Y-%m-%d %H:%M:%S"), "Users\tntdr\Downloads\turn_videos\violations"]
    return info_list
...
print(result_info)
    ...
    #detect_turn('wrongway.mp4','wrongway.mp4')
